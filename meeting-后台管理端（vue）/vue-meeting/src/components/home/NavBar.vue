      ...
      <div class="right-menu">
        ...
        <el-dropdown @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="personal"> <i class="el-icon-s-custom" />个人中心 </el-dropdown-item>
            <el-dropdown-item command="logout" divided> <i class="iconfont el-icon-mytuichu" />退出登录 </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
    </div>
